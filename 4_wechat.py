...
list_code = (100105,100118,100120,100122,100140,100141,103195,103233,103275,103407,103695,104657,104661,104738,104656,105042,105078,105171)  #100105,100118,100120,100122,100140,100141,103195,103233,103275,103407,103695,104657,104661,104738,104656,105042,105078,105171

# 文件所在路径
path = r'D:\1.office_syx\不良\每日不良汇报' + '\\'

# 循环发送
for n in range(len(list_code)):
    # 发送文件消息（图片、文档、压缩包等）
    SendWxFileMsg(str(list_code[n]), path + str(list_code[n])+'-'+yesterday_format + '不良.xlsx')
